...
namespace Oxide.Game.Rust
{
    ...
    public partial class RustCore
    {
        ...
        private object OnVehiclePush(BasePlayer player, BaseVehicle vehicle)
        {
            return Interface.Oxide.CallDeprecatedHook("CanPushBoat", "OnVehiclePush(BaseVehicle vehicle, BasePlayer player)",
                new System.DateTime(2020, 9, 4), vehicle, player);
        }
